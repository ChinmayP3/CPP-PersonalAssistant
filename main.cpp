...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Chinmay"<<endl;
        string phrase = "Good Morning Chinmay  ";
        ...
        cout<< "Good Afternoon  Chinmay"<<endl;
        string phrase = "Good Afternoon  Chinmay";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Chinmay"<<endl;
        string phrase = "Good Evening Chinmay";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE CHINMAY|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE CHINMAY";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="Chinmay")
        {
            ...
            do{
                ...
                string phrase = "How can i help you Chinmay";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Chinmay....."<<endl;
                    string phrase = "Hello Chinmay";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Chinmay "<<endl;
                    string phrase = "I'm a personal assistant created by Chinmay !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
...
//                    const char *charCommand = command.c_str();
//                    system(charCommand);
//                    CreateProcess(TEXT("C:\Program Files\Microsoft Office\Office14"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
//                }
//
...
//
                ...
                {
                    cout<<"Good Bye Chinmay, see you soon!"<<endl;
                    string phrase = "Good Bye Chinmay, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
